...
<div id="wpalrp_right">
  ...
  <div class="wpalrp_widget">
    ...
    <p>You can make my day by submitting a positive review on <a href="https://wordpress.org/plugins/wp-ajax-login-and-register-popup/#reviews" target="_blank"><strong>WordPress.org!</strong> <img src="<?php bloginfo('url' ); echo"/wp-content/plugins/wp-ajax-login-and-register-popup/img/review.png"; ?>" alt="review" class="review"/></a></p>
